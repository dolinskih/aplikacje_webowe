...
var server = http.createServer(function (req, res) { return __awaiter(void 0, void 0, void 0, function () {
    var url, method, html, html, json, body_1;
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                ...
                return [4 /*yield*/, (0, promises_1.readFile)('./index.html')];
            case 1:
                html = _a.sent();
                res.statusCode = 200;
                ...
                return [3 /*break*/, 5];
            case 2:
                if (!(url === '/dziekujemy')) return [3 /*break*/, 4];
                return [4 /*yield*/, (0, promises_1.readFile)('./thankyou.html')];
            case 3:
                html = _a.sent();
                res.statusCode = 200;
                res.setHeader('Content-Type', 'text/html');
...
server.listen(port, hostname, function () {
    console.log("Server running at https://".concat(hostname, ":").concat(port, "."));
});
